...
! gfortran -Wall -o calcwetf calcwetf.f90 -I/home/public/easybuild/software/netCDF-Fortran/4.6.1-gompi-2023a/include -lnetcdff
...
! -------------------------------------------------------
! new version updated to estimate wet days on the native GCM grid
! preprocess the statsfile with cdo remapmean to match the resolution of the GCM

call getarg(1,precfile)
call getarg(2,statsfile)
call getarg(3,wetffile)
...
! ----
! NB the coefficients expect input in the form of monthly mean of daily precipitation rate (mm day-1)
